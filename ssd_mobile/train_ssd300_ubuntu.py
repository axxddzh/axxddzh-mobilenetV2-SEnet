...
if __name__ == '__main__':
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='/media/axxddzh/database/VOC', help='dataset')
    # 文件保存地址
    parser.add_argument('--output-dir', default='./save_weights', help='path where to save')
    # 若需要接着上次训练，则指定上次训练保存权重文件地址
    parser.add_argument('--resume', default='./save_weights/ssd300-299.pth', type=str, help='resume from checkpoint')
    # 指定接着从哪个epoch数开始训练
    parser.add_argument('--start_epoch', default=150, type=int, help='start epoch')
    # 训练的总epoch数
