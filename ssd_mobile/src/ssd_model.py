...
from src.mobile_backbone import MobileBackbone
...
class Backbone(nn.Module):
    def __init__(self, pretrain_path=None):
        ...
        #net = resnet50()
        net = MobileBackbone()
        self.out_channels = [32, 64, 96, 160, 320, 320]
...
class SSD300(nn.Module):
    def __init__(self, backbone=None, num_classes=21):
        ...
        # out_channels = [32, 64, 96, 160, 320, 320] for mobile
    ...
    def _build_additional_features(self, input_size):
        ...
        """
        additional_blocks = []
        # input_size = [32, 64, 96, 160, 320, 320] for resnet50
    ...
    def forward(self, image, targets=None):
        ...
        # Feature Map 38x38x32, 19x19x64, 10x10x96, 5x5x160, 3x3x320, 1x1x320
